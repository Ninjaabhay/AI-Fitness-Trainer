...
if app_mode == "About":
    ...
    class angleFinder:
        ...
        def angle(self):
            if len(self.lmlist) != 0:
                ...
                leftHandAngle = int(
                    np.interp(leftHandAngle, [42, 143], [100, 0]))
    ...
    if st.session_state['type'] == 'Start':
        ...
        while cap.isOpened():
            ...
            lmList, bboxInfo = detector.findPosition(
                img, bboxWithHands=0, draw=False)
            ...
            cv2.putText(img, str(int(counter)), (1, 70),
                        cv2.FONT_HERSHEY_SCRIPT_SIMPLEX, 1.6, (0, 0, 255), 6)
            ...
            cv2.rectangle(img, (582, int(leftval)),
                          (632, 480), (0, 0, 255), -1)
        ...
        fig = go.Figure(
            data=[go.Bar(x=['Bicep Curls'], y=[calories1], name='Calories Burned')])

        fig.add_trace(go.Bar(x=['Bicep Curls'], y=[
                      goal_calorie1], name='Goal Calorie'))
    ...
    if st.session_state['type'] == 'Start2':
        ...
        fig = go.Figure(
            data=[go.Bar(x=['Bicep Curls'], y=[calories2], name='Calories Burned')])

        fig.add_trace(go.Bar(x=['Bicep Curls'], y=[
                      goal_calorie2], name='Goal Calorie'))
    ...
    class angleFinder:
        ...
        def angle(self):
            if len(self.lmlist) != 0:
                ...
                leftLegAngle = int(
                    np.interp(leftLegAngle, [42, 143], [100, 0]))
    ...
    if st.session_state['type'] == 'Start3':
        ...
        while cap.isOpened():
            ...
            angle1 = angleFinder(lmList, 24, 26, 28, 23,
                                 25, 27, drawPoints=True)
            left = angle1.angle()
        ...
        fig = go.Figure(
            data=[go.Bar(x=['Bicep Curls'], y=[calories3], name='Calories Burned')])

        fig.add_trace(go.Bar(x=['Bicep Curls'], y=[
                      goal_calorie3], name='Goal Calorie'))
    ...
    def angles(lmlist, p1, p2, p3, p4, p5, p6, drawpoints):
        ...
        if len(lmlist) != 0:
            ...
            rightHandAngle = int(
                np.interp(righthandangle, [34, 173], [100, 0]))
            ...
            cv2.rectangle(img, (0, 0), (120, 120), (255, 0, 0), -1)
            cv2.putText(img, str(int(counter)), (20, 70),
                        cv2.FONT_HERSHEY_SCRIPT_SIMPLEX, 1.6, (0, 0, 255), 7)

            leftval = np.interp(right, [0, 100], [400, 200])
            rightval = np.interp(right, [0, 100], [400, 200])

            cv2.putText(img, 'R', (24, 195),
                        cv2.FONT_HERSHEY_DUPLEX, 1, (255, 0, 255), 7)
            cv2.rectangle(img, (8, 200), (50, 400), (0, 255, 0), 5)
            cv2.rectangle(img, (8, int(rightval)), (50, 400), (255, 0, 0), -1)

            cv2.putText(img, 'L', (962, 195),
                        cv2.FONT_HERSHEY_DUPLEX, 1, (255, 0, 255), 7)
            cv2.rectangle(img, (952, 200), (995, 400), (0, 255, 0), 5)
            cv2.rectangle(img, (952, int(leftval)),
                          (995, 400), (255, 0, 0), -1)
            ...
            if right > 70:
                cv2.rectangle(img, (8, int(leftval)),
                              (50, 400), (0, 0, 255), -1)
    ...
    if st.session_state['type'] == 'Start4':
        ...
        fig = go.Figure(
            data=[go.Bar(x=['Bicep Curls'], y=[calories4], name='Calories Burned')])

        fig.add_trace(go.Bar(x=['Bicep Curls'], y=[
                      goal_calorie4], name='Goal Calorie'))
    ...
    class angleFinder:
        ...
        def angle(self):
            if len(self.lmlist) != 0:
                ...
                leftHandAngle = int(
                    np.interp(leftHandAngle, [-170, 180], [100, 0]))
                # rightHandAngle = int(np.interp(rightHandAngle, [-50, 20], [100, 0]))
                rightHandAngle = int(
                    np.interp(rightHandAngle, [-170, 180], [100, 0]))
    ...
    if st.session_state['type'] == 'Start5':
        ...
        while cap.isOpened():
            ...
            angle1 = angleFinder(lmList, 11, 13, 15, 12,
                                 14, 16, drawPoints=True)
            hands = angle1.angle()
            ...
            cv2.putText(img, 'R', (24, 195),
                        cv2.FONT_HERSHEY_DUPLEX, 1, (255, 0, 0), 5)
            cv2.rectangle(img, (8, 200), (50, 400), (0, 255, 0), 5)
            cv2.rectangle(img, (8, int(rightval)), (50, 400), (255, 0, 0), -1)

            # Drawing left rectangle and putting text
            cv2.putText(img, 'L', (900, 195),
                        cv2.FONT_HERSHEY_DUPLEX, 1, (255, 0, 0), 5)
            cv2.rectangle(img, (882, 200), (932, 400), (0, 255, 0), 5)
            cv2.rectangle(img, (882, int(leftval)),
                          (932, 400), (255, 0, 0), -1)
            ...
            if value_right > 70:
                cv2.rectangle(img, (8, int(rightval)),
                              (50, 400), (0, 0, 255), -1)
        ...
        fig = go.Figure(
            data=[go.Bar(x=['Bicep Curls'], y=[calories5], name='Calories Burned')])

        fig.add_trace(go.Bar(x=['Bicep Curls'], y=[
                      goal_calorie5], name='Goal Calorie'))
