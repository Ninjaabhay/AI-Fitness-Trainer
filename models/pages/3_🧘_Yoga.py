...
# img3 = Image.open(
#     "E:\AI Fitness Trainer\models\images\Eka_Pada_Pranamasana.png")
# img4 = Image.open(
#     "E:\AI Fitness Trainer\models\images\Ashwa_Sanchalanasana.webp")
...
img3 = Image.open(
    "images/Eka_Pada_Pranamasana.png")
img4 = Image.open(
    "images/Ashwa_Sanchalanasana.webp")
...
app_mode = st.sidebar.selectbox(
    "Choose the exercise", ["About", "Track 1", "Track 2"])
    ...
    while start and not stop:
        ...
        try:
            ...
            if pose_number == 1:
                ...
                distance = np.sqrt(
                    (right_wrist[0] - left_wrist[0])**2 + (right_wrist[1] - left_wrist[1])**2)
                if left_angle < 100 and right_angle < 100 and distance < 0.1:
                    cv2.putText(image, "Pose: Correct", (50, 50),
                                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
                    counter, pose_number = count_time(5)
                    cv2.putText(image, f"TIME: {int(counter)}s", (50, 100),
                                cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
                else:
                    cv2.putText(image, "Pose: Incorrect", (50, 50),
                ...
                if left_angle > 100 and right_angle > 100 and right_knee < 90 and distance < 0.1:
                    cv2.putText(image, "asana: Correct", (50, 50),
                                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
                    counter, pose_number = count_time(5)
                    cv2.putText(image, f"TIME: {int(counter)}s", (50, 100),
                                cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
            ...
            # Ashwa Sanchalanasana
                ...
                if left_leg_angle > 90 and right_leg_angle < 150:
                    ...
                    cv2.putText(image, "asana: Incorrect", (50, 50),
                                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
                    counter = 0
            else:
                # pause the frame
                cv2.putText(image, "Track completed", (50, 50),
                            cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
